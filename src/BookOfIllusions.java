...
public class BookOfIllusions extends MouseAdapter {
	...
	private void createBook() {
		...
		loadImageFromComputer("Illusion1.jpg");
		loadImageFromComputer("Illusion2.jpg");
		loadImageFromComputer("Illusion3.jpg");
		loadImageFromComputer("Illusion4.jpg");
		loadImageFromComputer("Illusion5.jpg");
		loadImageFromComputer("Illusion6.jpg");
